            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                ...
                <div className="flex flex-wrap gap-2 w-full lg:w-auto">
                    ...
                    <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                        ...
                        <button
                            onClick={() => exportToExcelAdvanced(targetYearMonth, staffList, rawShifts, classes, timePatterns, businessHours, preferences, holidays, excelSettings, breakSettings)}
                        ...
                        <button
                            disabled
                            className="flex items-center justify-center space-x-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-400 dark:text-slate-500 px-3 py-2.5 rounded-xl shadow-none transition-colors flex-1 cursor-not-allowed"
                            title="PDF出力機能は現在準備中です"
                        >
                            <Download className="w-5 h-5 text-slate-300 dark:text-slate-600" />
                            <span className="hidden sm:inline text-xs font-bold whitespace-nowrap">PDF (準備中)</span>
                        </button>
                    </div>
                </div>
            </div>
