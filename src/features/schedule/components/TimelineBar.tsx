...
const TimelineBar: React.FC<TimelineBarProps> = ({
    ...
    return (
        <div className={`flex-1 relative ${readOnly ? 'py-1 min-h-[36px]' : 'py-2 min-h-[52px]'} w-full bg-white dark:bg-slate-800`} ref={trackRef} style={{ touchAction: readOnly ? 'pan-y' : 'none' }}>
            {renderGridLines()}
            <div
