    ...
    <>
        ...
        <div className="px-5 pt-4">
            <div className="grid grid-cols-7 gap-1.5 sm:gap-2.5 mb-2">
                {['日', '月', '火', '水', '木', '金', '土'].map((d) => (
                    <div key={d} className={`text-center text-xs font-bold py-1 ${d === '日' ? 'text-red-500 dark:text-red-400' : d === '土' ? 'text-blue-600 dark:text-blue-400' : 'text-slate-400 dark:text-slate-500'}`}>
                        {d}
                    </div>
                ))}
            </div>
            ...
            {prefLoading ? (
                ...
                <div className="grid grid-cols-7 gap-1.5 sm:gap-2.5">
                    ...
                    {(() => {
                        ...
                        const offset = firstDayObj.getDay();
                    ...
                    {preferences.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center p-1.5 sm:p-3 rounded-xl border-2 transition-all duration-150 select-none
