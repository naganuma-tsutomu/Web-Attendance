        ...
        >
            ...
            >
                <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                    ...
                    <button
                        onClick={() => setEditingDateIndex(null)}
                        className="bg-white dark:bg-slate-700 p-2 rounded-full shadow-sm hover:shadow-md transition-all text-slate-400 dark:text-slate-300"
                    >
                        <X className="w-5 h-5" />
                    </button>
                </div>
                        ...
                        {isPartial && (
                            <div className="flex flex-col items-center animate-in zoom-in-95 duration-300">
                                ...
                                <div className="bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-300 px-4 py-2 rounded-2xl font-bold flex items-center gap-2">
                                    <span className="font-mono text-lg">{day.startTime}</span>
                                    <span className="text-red-400">〜</span>
                                    <span className="font-mono text-lg">{day.endTime}</span>
                                </div>
                            </div>
                        )}
